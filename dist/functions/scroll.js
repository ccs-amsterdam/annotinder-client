...
exports.scrollToMiddle = exports.keepInView = void 0;
...
exports.scrollToMiddle = scrollToMiddle;

const keepInView = (parent, child) => {
  // scroll parent to position of child
  // position should be value between 0 and 1 for relative position between top (0) and bottom (1)
  const parentBounding = parent.getBoundingClientRect();
  const clientBounding = child.getBoundingClientRect();
  ...
  const needDown = clientTop > parentTop + parentHeight * 0.9; //if (needUp > 0) parent.scrollTop = parent.scrollTop + needUp;
