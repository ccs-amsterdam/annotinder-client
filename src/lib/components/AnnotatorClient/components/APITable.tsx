...
//  */
// const APITable = ({ getData, columns, onClick, pageSize, update }: APITableProps) => {
...
// const FooterContent = ({ pages, setPage, setSearch }: FooterContentProps) => {
...
//         defaultActivePage={1}
//         totalPages={pages}
//         onPageChange={(e, d) => setPage(Number(d.activePage))}
